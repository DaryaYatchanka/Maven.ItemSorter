...
public class SortByPriceTest {
    ...
    public void test1() {
        ...
        Item item2 = new Item(1L, "Banana", 13.5);
        Item item1 = new Item(2L, "Cherry", 3.06);
    ...
    public void test2() {
        // given
        Item item3 = new Item(3L, "Apple", 12.0);
        Item item2 = new Item(4L, "Banana", 28.5);
        Item item1 = new Item(5L, "Cherry", 19.0);
        Item[] itemsToSort = {item3, item1, item2};
    ...
    public void test3() {
        // given
        Item item3 = new Item(10L, "Apple", 21.0);
        Item item2 = new Item(15L, "Banana", 1.5);
        Item item1 = new Item(16L, "Cherry", 12.0);
        Item[] itemsToSort = {item3, item1, item2};
    ...
    public void test5() {
        // given
        Item item3 = new Item(10L, "Apple", 1.5);
        Item item2 = new Item(15L, "Banana", 1.5);
        Item item1 = new Item(16L, "Cherry", 12.0);
        Item[] itemsToSort = {item3, item2, item1};
